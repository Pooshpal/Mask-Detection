...
face_detection = mp.solutions.face_detection.FaceDetection(0.3)
...
while True:
    ...
    try:
        ...
        filename = "C:/Users/Pooshpal/Documents/Code/Mini Project/DataNew/" + class_path+"/"+ str(uuid.uuid4())+".jpg"
